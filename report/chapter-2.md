...
![Customer journey map 1.png](../images/journey_map/Customer%20journey%20map%201.png)

**Resumen del journey:** Claudia Morales, administradora del hogar, recibe a fin de mes la facturación de agua y detecta un incremento atípico que duplica su presupuesto regular (S/ 80 – S/ 120). Debido a sus extensas jornadas laborales, aprovecha el fin de semana para inspeccionar manualmente grifos, inodoros, cisterna y el medidor de la vereda, sin poder constatar si existen filtraciones ocultas en los muros de su vivienda de dos niveles. Tras contrastar dudas en grupos vecinales y descartar problemas externos, contrata a ciegas un servicio de gasfitería correctiva. Finalmente, abona el recibo para evitar el corte y asume un mes entero de incertidumbre pasiva hasta la llegada de la próxima facturación para verificar si la avería quedó realmente solucionada.

| Fase                         | Acción                                                                                                                         | Pensamiento                                                                              | Emoción                     | Punto de dolor                                                                                                         |
|------------------------------|--------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|-----------------------------|------------------------------------------------------------------------------------------------------------------------|
| **Recepción del recibo**     | Revisa la facturación mensual en banca móvil y detecta un cobro atípico de S/ 210, casi el doble de su promedio histórico.     | *"El monto se disparó sin explicación; no podemos haber consumido tanto."*               | Frustración / Enojo         | La información llega a mes vencido, sin desglose ni alertas previas cuando el desperdicio ya ocurrió.                  |
| **Búsqueda de señales**      | Realiza una inspección manual durante el fin de semana cerrando llaves, revisando boyas y observando el medidor de la fachada. | *"Las tuberías están empotradas; si la fuga es interna, no voy a verla a simple vista."* | Agotamiento / Preocupación  | Pérdida de horas de descanso en inspecciones domésticas engorrosas sin instrumental de diagnóstico preciso.            |
| **Consulta y decisión**      | Pregunta en el chat vecinal sobre cobros atípicos de Sedapal y solicita el contacto de un gasfitero de confianza.              | *"No sé si es un error de lectura de la empresa o una fuga silenciosa en los muros."*    | Incertidumbre / Incomodidad | Canales de atención oficiales lentos y falta de datos técnicos para determinar si procede un reclamo o una reparación. |
| **Aplicación de una medida** | Contrata un técnico para cambiar válvulas y empaques en sanitarios, asumiendo el gasto de mano de obra y repuestos.            | *"Espero que el cambio de piezas baste y no tengamos que picar paredes."*                | Tensión / Escepticismo      | Gasto correctivo imprevisto y ausencia de confirmación técnica inmediata que valide si el flujo anómalo cesó.          |
| **Verificación posterior**   | Paga el recibo elevado mediante su banca móvil y espera 30 días hasta el siguiente ciclo de facturación.                       | *"Tendré que esperar un mes entero para comprobar si la reparación realmente funcionó."* | Resignación / Desconfianza  | Dependencia absoluta del ciclo mensual de facturación para verificar la efectividad, arriesgando nuevos sobrecostos.   |
